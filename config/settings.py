...
"""
AUTH_USER_MODEL обязателен говорим что мы будем работать с нашей CustomUSer
"""
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend' # Серверная часть, используемая для отправки электронных писем.
EMAIL_HOST = 'smtp.gmail.com'# По умолчанию:'localhost' Хост, который будет использоваться для отправки электронной почты.
EMAIL_PORT = 587 # Порт, который будет использоваться для SMTP-сервера
